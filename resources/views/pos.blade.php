                  ...
                  <div class="col-lg-12">
                    <div class="row gx-3 mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input class="form-control" id="inputFirstName" type="text" readonly="readonly" value="{{ $faktur }}" >
                        </div>
                        <!-- Form Group (last name)-->
                        <div class="col-md-6">
                            <label class="small mb-1" for="inputLastName">Date Transcation</label>
                            <input class="form-control" id="inputLastName" type="text" readonly="readonly" value="{{ date('Y-m-d') }}" >
                        </div>
                    </div>
                    ...
                    <div class="row gx-3 mb-3">
                       ...
                       <button type="button" id="service" onclick="SearchService();"  class="btn btn-success btn-block"> Add Service</button>
                    </div>
                  </div>
                  <hr>
